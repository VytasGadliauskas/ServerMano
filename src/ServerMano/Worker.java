...
public class Worker extends Thread{
    ...
    public Worker(String name, Socket socket, String ROOT_DIR, Object threadLock, Logger LOGGER) {
        super(name);
        this.socket = socket;
    ...
    private void doRequest() {
        try (InputStream is = socket.getInputStream();
            ...
            int number = Main.getThreadNumber() - 1;
            LOGGER.info("Thread "+super.toString()+" work finished");
            Main.setThreadNumber(number);
